...
{
    public class SystemManagerGenericRepository<T> : IGenericRepository<T> where T : class
    {
        private DbContext context = null;
        private DbSet<T> table = null;

        public SystemManagerGenericRepository()
        {
            this.context = new SystemManagerEntities();
