...
{
    public class NonProductionGenericRepository<T> : IGenericRepository<T> where T : class
    {
        private DbContext context = null;
        private DbSet<T> table = null;

        public NonProductionGenericRepository()
        {
            this.context = new NonProductionCSEntities();
        ...
        // DELETE
        public void Delete(Inventory_Purchase_Order_AdvancePaid pOData, Expression<Func<T, bool>> predicate)
        {
